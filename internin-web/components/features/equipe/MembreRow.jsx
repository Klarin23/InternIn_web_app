...
export default function MembreRow({ membre, index, onOuvrirDetail }) {
  ...
  return (
    <div className="grid w-full grid-cols-[1.6fr_1.1fr_1fr_1.2fr] items-center gap-3 border-b border-border px-2 py-3.5 text-sm">
      <button
        type="button"
      ...
      <span>
        <span
          className={`rounded-full px-2.5 py-1 text-xs font-semibold ${STATUT_MEMBRE_COLORS[membre.statutMembre]}`}
        >
